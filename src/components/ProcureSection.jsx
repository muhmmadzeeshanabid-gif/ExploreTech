    ...
    <section className="w-full bg-[#17c53a] py-16">
      <div className="mx-auto grid w-full max-w-[1320px] grid-cols-1 items-center gap-12 px-6 lg:grid-cols-2 lg:gap-16 lg:px-10">
        ...
        >
          ...
          >
            {t("procure.description")}
          </p>
          <p
            className={`mt-6 text-[16px] font-bold leading-[24px] text-white ${isArabic ? "block w-full text-right lg:w-[653.025px]" : ""}`}
            style={{
              fontFamily: '"SF Pro Text", sans-serif',
              fontWeight: 700,
            }}
          >
            {t("procure.comingSoon")}
          </p>
        </div>
      </div>
    </section>
